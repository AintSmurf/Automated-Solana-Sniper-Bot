...
class TransactionManager:
    ...
    def process_signature(self, signature: str,tx_data=None, token_mint:str=None)->None:
        ...
        try:
            ...
            # record new token
            liquidity_snapshot_id = self.ctx.get("token_discovery_persistence_service").persist_discovered_token(signature,token_mint)
            ...
            run_timer(
                60.0,
                self.ctx.get("trade_enrichment_service").delayed_post_buy_handler,
                token_mint,signature, market_cap,liquidity_snapshot_id,
